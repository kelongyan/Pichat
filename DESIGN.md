...
>
> **Style**: Claude-inspired elegance — serif headings (`Libre Baskerville`), generous spacing, warm transitions, editorial feel. No cold/techy aesthetics.
>
> **Dark mode**: Inverted with warm dark tones (`#1a1a1a` bg), not pure black. All grays carry slight warmth.
